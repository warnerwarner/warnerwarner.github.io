    ...
    <div className="headerItems">
      ...
      <div className="headerText">
        <h1 className="titleText">Tom P. A. Warner </h1>
          ...
          <p  class="personDescription">Systems Neuroscientist</p>
        ...
        <div className='contactImage'>
          ...
          <div className='contactImage'>
              ...
              <img className="contactLogo" src="./images/github-icon-inverted.png"></img>
          </div>
          <a
              target="_blank"
